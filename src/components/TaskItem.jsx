  ...
  return (
    <li className='flex items-center gap-2 justify-between mb-3 border-b border-solid border-gray-300 pb-3'> 
        <div className='flex gap-2 items-center'>
            ...
            <span className='flex flex-col'> <span className=' mb-1'> {taskName} <span className='bg-green-200 text-xs px-2 rounded-lg py-1'> {teamMember} </span> </span>  <span className='text-sm text-gray-600'> Date: {taskDate} </span> </span> 
        </div>
